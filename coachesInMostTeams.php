...
$result = $conn->query(
    "SELECT u.Fname, u.Lname, u.USERID, COUNT(co.TeamID) AS TeamCount
     FROM Coaches co
     JOIN Users u ON co.C_USERID = u.USERID
     GROUP BY co.C_USERID
...
<html lang="en">
<head>
    <title>Coaches in Most Teams - Sport LFC</title>
    <style>
...
<body>
<div class="container">
    <h1>Coaches Coaching Most Teams</h1>
    <p class="sub">Ranked by number of teams each coach is assigned to</p>
    <table>
        <tr><th>Rank</th><th>Coach</th><th>ID</th><th>Teams</th></tr>
